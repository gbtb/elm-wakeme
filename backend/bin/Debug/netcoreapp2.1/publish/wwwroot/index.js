...
var author$project$Main$UpdateMapWindowPosition = function (a) {
	return {$: 'UpdateMapWindowPosition', a: a};
};
...
var author$project$Main$defaultLocation = {
	accuracy: 0.0,
...
var author$project$Maps$Internal$LatLng$sydney = {lat: -33.865143, lng: 151.2099};
...
var author$project$Maps$Internal$Maps$defaultModel = function () {
	var map = {center: author$project$Maps$Internal$LatLng$sydney, height: 400, tileServer: 'http://a.tile.osm.org/{z}/{x}/{y}.png', tileSize: 256, width: 600, zoom: 10};
	return {cache: _List_Nil, drag: elm$core$Maybe$Nothing, map: map, markers: _List_Nil, pinch: elm$core$Maybe$Nothing};
}();
var author$project$Maps$Internal$OpaqueTypes$Model = function (a) {
	return {$: 'Model', a: a};
};
...
var author$project$Maps$defaultModel = author$project$Maps$Internal$OpaqueTypes$Model(author$project$Maps$Internal$Maps$defaultModel);
var author$project$Maps$Internal$LatLng$LatLng = F2(
	function (lat, lng) {
		return {lat: lat, lng: lng};
	});
var author$project$Maps$Geo$latLng = author$project$Maps$Internal$LatLng$LatLng;
var author$project$Main$defaultModel = {
	clientPos: _Utils_Tuple2(0, 0),
	currentLocation: author$project$Main$defaultLocation,
	desiredLocation: A2(author$project$Maps$Geo$latLng, 0, 0),
	map: author$project$Maps$defaultModel,
...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		...
		A2(
			...
			author$project$Main$UpdateMapWindowPosition,
			elm$browser$Browser$Dom$getElement('mapWindow')));
};
var author$project$Geolocation$changes = _Platform_incomingPort('changes', elm$json$Json$Decode$value);
...
var author$project$Geolocation$Location = F6(
...
var author$project$Geolocation$posixDecoder = A2(elm$json$Json$Decode$map, elm$time$Time$millisToPosix, elm$json$Json$Decode$int);
var author$project$Geolocation$Altitude = F2(
	function (value, accuracy) {
		return {accuracy: accuracy, value: value};
	});
var elm$json$Json$Decode$float = _Json_decodeFloat;
var author$project$GeolocationDecoders$altitudeDecoder = A3(
	...
	A3(
		...
		'value',
		elm$json$Json$Decode$float,
		elm$json$Json$Decode$succeed(author$project$Geolocation$Altitude)));
var elm$json$Json$Decode$null = _Json_decodeNull;
var elm$json$Json$Decode$oneOf = _Json_oneOf;
var author$project$GeolocationDecoders$maybeDecoder = function (decoder) {
...
var author$project$Geolocation$Moving = function (a) {
	return {$: 'Moving', a: a};
};
var author$project$Geolocation$Static = {$: 'Static'};
var author$project$Geolocation$MovingData = F2(
	function (speed, degreesFromNorth) {
		return {degreesFromNorth: degreesFromNorth, speed: speed};
	});
var author$project$GeolocationDecoders$movingDataDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'degreesFromNorth',
	elm$json$Json$Decode$float,
	A3(
		...
		'speed',
		elm$json$Json$Decode$float,
		elm$json$Json$Decode$succeed(author$project$Geolocation$MovingData)));
var author$project$GeolocationDecoders$movementDecoder = elm$json$Json$Decode$oneOf(
	_List_fromArray(
		[
			A2(
			elm$json$Json$Decode$field,
			'Static',
			elm$json$Json$Decode$succeed(author$project$Geolocation$Static)),
			A2(
			elm$json$Json$Decode$field,
			'Moving',
			A2(elm$json$Json$Decode$map, author$project$Geolocation$Moving, author$project$GeolocationDecoders$movingDataDecoder))
		]));
var author$project$GeolocationDecoders$locationDecoder = A3(
	NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
	'timestamp',
	author$project$Geolocation$posixDecoder,
	A3(
		NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
		'movement',
		author$project$GeolocationDecoders$maybeDecoder(author$project$GeolocationDecoders$movementDecoder),
		A3(
			NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
			'altitude',
			author$project$GeolocationDecoders$maybeDecoder(author$project$GeolocationDecoders$altitudeDecoder),
			A3(
				NoRedInk$elm_json_decode_pipeline$Json$Decode$Pipeline$required,
				'accuracy',
				elm$json$Json$Decode$float,
				A3(
					...
					A3(
						...
						'latitude',
						elm$json$Json$Decode$float,
						elm$json$Json$Decode$succeed(author$project$Geolocation$Location)))))));
var author$project$Main$LocationUpdated = function (a) {
	return {$: 'LocationUpdated', a: a};
};
var author$project$Main$processLocation = function (value) {
	return author$project$Main$LocationUpdated(
		A2(elm$json$Json$Decode$decodeValue, author$project$GeolocationDecoders$locationDecoder, value));
};
var author$project$Main$subscriptions = function (model) {
	return author$project$Geolocation$changes(author$project$Main$processLocation);
};
var author$project$Main$MapsMsg = function (a) {
	return {$: 'MapsMsg', a: a};
};
var elm$core$Basics$sqrt = _Basics_sqrt;
var author$project$Main$isDifferentFrom = F3(
	function (threshold, oldLocation, newLocation) {
		var difLong = oldLocation.longitude - newLocation.longitude;
		var difLat = oldLocation.latitude - newLocation.latitude;
		var metric = elm$core$Basics$sqrt((difLat * difLat) + (difLong * difLong));
		return _Utils_cmp(metric, threshold) > 0;
	});
var author$project$Main$positionMarker = elm$html$Html$text('➘');
var author$project$Main$targetMarker = elm$html$Html$text('\u29bf');
var author$project$Maps$Internal$Drag$Drag = F2(
	function (a, b) {
		return {$: 'Drag', a: a, b: b};
	});
var author$project$Maps$Internal$Drag$drag = F2(
	function (offsetValue, state) {
		if (state.$ === 'StartDrag') {
			var startValue = state.a;
			return A2(author$project$Maps$Internal$Drag$Drag, startValue, offsetValue);
		} else {
			var end = state.b;
			return A2(author$project$Maps$Internal$Drag$Drag, end, offsetValue);
		}
	});
var author$project$Maps$Internal$Drag$StartDrag = function (a) {
	return {$: 'StartDrag', a: a};
};
var author$project$Maps$Internal$Drag$start = author$project$Maps$Internal$Drag$StartDrag;
var author$project$Maps$Internal$Drag$offset = function (dragValue) {
	if (dragValue.$ === 'StartDrag') {
		return {x: 0, y: 0};
	} else {
		var startValue = dragValue.a;
		var end = dragValue.b;
		return {x: end.x - startValue.x, y: end.y - startValue.y};
	}
};
var author$project$Maps$Internal$Screen$Offset = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var author$project$Maps$Internal$Tile$Offset = F2(
	function (x, y) {
		return {x: x, y: y};
	});
var author$project$Maps$Internal$Utils$wrap = F3(
	function (min, max, n) {
		return (_Utils_cmp(n, min) < 0) ? A3(author$project$Maps$Internal$Utils$wrap, min, max, n + (max - min)) : ((_Utils_cmp(n, max) > -1) ? A3(author$project$Maps$Internal$Utils$wrap, min, max, n - (max - min)) : n);
	});
...
var author$project$Maps$Internal$Tile$fromLatLng = F2(
	function (zoom, loc) {
		var n = A2(elm$core$Basics$pow, 2, zoom);
		var x = A3(author$project$Maps$Internal$Utils$wrap, 0, n, n * ((loc.lng + 180) / 360));
		var latRad = (loc.lat * elm$core$Basics$pi) / 180;
		var y = (n * (1 - (A2(
			elm$core$Basics$logBase,
			elm$core$Basics$e,
			elm$core$Basics$abs(
				elm$core$Basics$tan(latRad) + (1 / elm$core$Basics$cos(latRad)))) / elm$core$Basics$pi))) / 2;
		return A2(author$project$Maps$Internal$Tile$Offset, x, y);
	});
var author$project$Maps$Internal$Screen$offsetToTileOffset = F2(
	function (_n0, offset) {
		...
		var centerTile = A2(
			author$project$Maps$Internal$Tile$fromLatLng,
			elm$core$Basics$ceiling(zoom),
			center);
		var centerOffset = A2(author$project$Maps$Internal$Screen$Offset, offset.x - (width / 2), offset.y - (height / 2));
		return A2(author$project$Maps$Internal$Tile$Offset, centerTile.x + (centerOffset.x / tileSize), centerTile.y + (centerOffset.y / tileSize));
	});
var author$project$Maps$Internal$Utils$sinh = function (x) {
...
var author$project$Maps$Internal$Tile$toLatLng = F3(
	function (zoom, tileX, tileY) {
		var n = A2(elm$core$Basics$pow, 2, zoom);
		var lngDeg = A3(author$project$Maps$Internal$Utils$wrap, -180, 180, ((tileX / n) * 360) - 180);
		var latRad = elm$core$Basics$atan(
			author$project$Maps$Internal$Utils$sinh(elm$core$Basics$pi * (1 - ((2 * tileY) / n))));
		var latDeg = (latRad * 180) / elm$core$Basics$pi;
		return A2(author$project$Maps$Internal$LatLng$LatLng, latDeg, lngDeg);
	});
var author$project$Maps$Internal$Screen$offsetToLatLng = F2(
	function (map, offset) {
		var zoom = map.zoom;
		return function (tile) {
			return A3(
				author$project$Maps$Internal$Tile$toLatLng,
				elm$core$Basics$ceiling(zoom),
				tile.x,
				tile.y);
		}(
			A2(author$project$Maps$Internal$Screen$offsetToTileOffset, map, offset));
	});
var author$project$Maps$Internal$Map$move = F2(
	function (offsetArg, map) {
		var centerOffset = function (offset) {
			return A2(author$project$Maps$Internal$Screen$Offset, (map.width / 2) - offset.x, (map.height / 2) - offset.y);
		};
		return _Utils_update(
			map,
			{
				center: A2(
					author$project$Maps$Internal$Screen$offsetToLatLng,
					map,
					centerOffset(offsetArg))
			});
	});
var author$project$Maps$Internal$Map$drag = F2(
	function (dragState, map) {
		return A2(
			author$project$Maps$Internal$Map$move,
			author$project$Maps$Internal$Drag$offset(dragState),
			map);
	});
...
var author$project$Maps$Internal$Map$zoom = F2(
	function (zoomLevel, map) {
		return _Utils_update(
			map,
			{
				zoom: A2(
					elm$core$Basics$min,
					19,
					A2(elm$core$Basics$max, 0, map.zoom + zoomLevel))
			});
	});
var author$project$Maps$Internal$Map$zoomTo = F3(
	function (zoomLevel, offset, map) {
		return A2(
			author$project$Maps$Internal$Map$move,
			{x: -((map.width / 2) - offset.x), y: -((map.height / 2) - offset.y)},
			A2(
				author$project$Maps$Internal$Map$zoom,
				zoomLevel,
				A2(
					author$project$Maps$Internal$Map$move,
					{x: (map.width / 2) - offset.x, y: (map.height / 2) - offset.y},
...
var author$project$Maps$Internal$Maps$updateMap = F2(
		...
		return _Utils_update(
			model,
			{
				cache: A2(
					...
					A2(elm$core$List$cons, model.map, model.cache)),
				map: updateFunc(model.map)
			});
	});
var author$project$Maps$Internal$Pinch$Pinch = F2(
	function (a, b) {
		return {$: 'Pinch', a: a, b: b};
	});
var author$project$Maps$Internal$Pinch$pinch = F2(
	function (twoFingers, state) {
		if (state.$ === 'StartPinch') {
			var startVal = state.a;
			return A2(author$project$Maps$Internal$Pinch$Pinch, startVal, twoFingers);
		} else {
			var startVal = state.a;
			var end = state.b;
			return A2(author$project$Maps$Internal$Pinch$Pinch, startVal, twoFingers);
...
var author$project$Maps$Internal$Pinch$StartPinch = function (a) {
	return {$: 'StartPinch', a: a};
};
var author$project$Maps$Internal$Pinch$start = author$project$Maps$Internal$Pinch$StartPinch;
var author$project$Maps$Internal$Utils$flip = F3(
	function (f, a, b) {
		return A2(f, b, a);
	});
var author$project$Maps$Internal$Pinch$startEnd = function (pinchArg) {
	if (pinchArg.$ === 'StartPinch') {
		var startVal = pinchArg.a;
		return _Utils_Tuple2(startVal, startVal);
	} else {
		var startVal = pinchArg.a;
		var end = pinchArg.b;
		return _Utils_Tuple2(startVal, end);
	}
};
var author$project$Maps$Internal$Zoom$fromPinch = F3(
	function (mapWidth, mapHeight, pinch) {
		var _n0 = author$project$Maps$Internal$Pinch$startEnd(pinch);
		var start = _n0.a;
		var end = _n0.b;
		return _Utils_Tuple2(
			A2(elm$core$Basics$logBase, 2, end.length / start.length),
			start.center);
	});
...
var author$project$Maps$Internal$Maps$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'DragStart':
				var offset = msg.a;
				var dragState = _Utils_eq(model.pinch, elm$core$Maybe$Nothing) ? elm$core$Maybe$Just(
					author$project$Maps$Internal$Drag$start(offset)) : elm$core$Maybe$Nothing;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{drag: dragState}),
			...
			case 'DragTo':
				var offset = msg.a;
				var dragState = _Utils_eq(model.pinch, elm$core$Maybe$Nothing) ? A2(
					elm$core$Maybe$map,
					author$project$Maps$Internal$Drag$drag(offset),
					model.drag) : elm$core$Maybe$Nothing;
				var draggedMap = function (map) {
					return A2(
						elm$core$Maybe$withDefault,
						map,
						A2(
							elm$core$Maybe$map,
							A2(author$project$Maps$Internal$Utils$flip, author$project$Maps$Internal$Map$drag, map),
							dragState));
				};
				return _Utils_Tuple2(
					A2(
						author$project$Maps$Internal$Maps$updateMap,
						draggedMap,
						_Utils_update(
							model,
							{drag: dragState})),
			...
			case 'PinchStart':
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pinch: elm$core$Maybe$Just(
								author$project$Maps$Internal$Pinch$start(fingers))
						}),
					elm$core$Platform$Cmd$none);
			case 'PinchTo':
				var fingers = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							pinch: A2(
								elm$core$Maybe$map,
								author$project$Maps$Internal$Pinch$pinch(fingers),
								model.pinch)
						}),
					elm$core$Platform$Cmd$none);
			case 'PinchStop':
				var zoom = A2(
					elm$core$Maybe$map,
					A2(author$project$Maps$Internal$Zoom$fromPinch, model.map.width, model.map.height),
					model.pinch);
				var pinchedMap = function (map) {
					if (zoom.$ === 'Just') {
						var _n2 = zoom.a;
						var zoomVal = _n2.a;
						var offset = _n2.b;
						return A3(author$project$Maps$Internal$Map$zoomTo, zoomVal, offset, map);
					} else {
						return map;
					}
				};
			...
			case 'Zoom':
				...
				return _Utils_Tuple2(
					A2(
						author$project$Maps$Internal$Maps$updateMap,
						A2(author$project$Maps$Internal$Map$zoomTo, zoom, offset),
						model),
					elm$core$Platform$Cmd$none);
			default:
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var author$project$Maps$update = F2(
	function (msg, _n0) {
		var model = _n0.a;
		return A2(
			elm$core$Tuple$mapFirst,
			author$project$Maps$Internal$OpaqueTypes$Model,
			A2(author$project$Maps$Internal$Maps$update, msg, model));
	});
var author$project$Maps$Internal$OpaqueTypes$opaqueModel = F2(
	function (update, _n0) {
		var model = _n0.a;
		return author$project$Maps$Internal$OpaqueTypes$Model(
			update(model));
	});
var author$project$Maps$Internal$OpaqueTypes$Map = function (a) {
	return {$: 'Map', a: a};
};
var author$project$Maps$Internal$OpaqueTypes$transparentMap = F2(
	function (update, map) {
		var _n0 = update(
			author$project$Maps$Internal$OpaqueTypes$Map(map));
		var updatedMap = _n0.a;
		return updatedMap;
	});
var author$project$Maps$updateMap = function (updateFunc) {
	return author$project$Maps$Internal$OpaqueTypes$opaqueModel(
		author$project$Maps$Internal$Maps$updateMap(
			author$project$Maps$Internal$OpaqueTypes$transparentMap(updateFunc)));
};
var author$project$Maps$Internal$Maps$updateMarkers = F2(
	function (updateFunc, model) {
		return _Utils_update(
			model,
			{
...
var author$project$Maps$updateMarkers = function (updateFunc) {
	return author$project$Maps$Internal$OpaqueTypes$opaqueModel(
		author$project$Maps$Internal$Maps$updateMarkers(updateFunc));
};
var author$project$Maps$Internal$OpaqueTypes$getMapInternal = function (_n0) {
	var model = _n0.a;
	return model.map;
};
var author$project$Maps$Convert$getMap = function (model) {
	return author$project$Maps$Internal$OpaqueTypes$getMapInternal(model);
};
var author$project$Maps$Convert$screenOffsetToLatLng = F2(
	function (map, offset) {
		return A2(author$project$Maps$Internal$Screen$offsetToLatLng, map, offset);
	});
var author$project$Maps$Internal$Bounds$Centered = function (a) {
	return {$: 'Centered', a: a};
};
var author$project$Maps$Geo$centeredBounds = F2(
	function (zoom, latLngVal) {
		return author$project$Maps$Internal$Bounds$Centered(
			{center: latLngVal, zoom: zoom});
	});
var author$project$Maps$Internal$Bounds$center = function (boundsArg) {
	if (boundsArg.$ === 'Bounds') {
		var bounds = boundsArg.a;
		return {lat: (bounds.northEast.lat + bounds.southWest.lat) / 2, lng: (bounds.northEast.lng + bounds.southWest.lng) / 2};
	} else {
		var bounds = boundsArg.a;
		return bounds.center;
	}
};
var author$project$Maps$Internal$Bounds$getZoomVal = F3(
	function (mapSize, tileSize, frac) {
		return A2(elm$core$Basics$logBase, 2, (mapSize / tileSize) / frac);
	});
var elm$core$Basics$sin = _Basics_sin;
var author$project$Maps$Internal$Bounds$zoom = F4(
	function (tileSize, mapWidth, mapHeight, boundsArg) {
		if (boundsArg.$ === 'Bounds') {
			var bounds = boundsArg.a;
			...
			var _n1 = _Utils_Tuple2(bounds.northEast, bounds.southWest);
			var ne = _n1.a;
			var sw = _n1.b;
			var latFraction = latRad(ne.lat) - latRad(sw.lat);
			var lngFraction = A3(author$project$Maps$Internal$Utils$wrap, 0, 360, ne.lng - sw.lng) / 360;
			return A2(
				elm$core$Basics$min,
				A3(author$project$Maps$Internal$Bounds$getZoomVal, mapWidth, tileSize, lngFraction),
				A3(author$project$Maps$Internal$Bounds$getZoomVal, mapHeight, tileSize, latFraction));
		} else {
			var boundsValue = boundsArg.a;
			return boundsValue.zoom;
		}
	});
var author$project$Maps$Internal$Map$zoomHelper = F2(
	function (bounds, map) {
		return A4(author$project$Maps$Internal$Bounds$zoom, map.tileSize, map.width, map.height, bounds);
	});
var author$project$Maps$Internal$Map$viewBounds = F2(
	function (bounds, map) {
		return _Utils_update(
			map,
			{
				center: author$project$Maps$Internal$Bounds$center(bounds),
				zoom: A2(author$project$Maps$Internal$Map$zoomHelper, bounds, map)
			});
	});
var author$project$Maps$Internal$OpaqueTypes$opaqueMap = F2(
	function (update, _n0) {
		var map = _n0.a;
		return author$project$Maps$Internal$OpaqueTypes$Map(
			update(map));
	});
var author$project$Maps$Map$viewBounds = function (bounds) {
	return author$project$Maps$Internal$OpaqueTypes$opaqueMap(
		author$project$Maps$Internal$Map$viewBounds(bounds));
};
var author$project$Maps$Internal$Marker$CustomMarker = F2(
	function (a, b) {
		return {$: 'CustomMarker', a: a, b: b};
	});
var author$project$Maps$Marker$createCustom = author$project$Maps$Internal$Marker$CustomMarker;
...
var author$project$Main$update = F2(
	function (msgArg, model) {
		switch (msgArg.$) {
			case 'NoOp':
				return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
			case 'UpdateMapWindowPosition':
				var res = msgArg.a;
				if (res.$ === 'Ok') {
					var elem = res.a;
					var e = A2(elm$core$Debug$log, 'e', elem);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{topPos: e.element.y}),
			...
			case 'MapsMsg':
				var msg = msgArg.a;
				var _n2 = A2(author$project$Maps$update, msg, model.map);
				var updatedMap = _n2.a;
				var cmds = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{map: updatedMap}),
					A2(elm$core$Platform$Cmd$map, author$project$Main$MapsMsg, cmds));
			case 'LocationUpdated':
				var locationRes = msgArg.a;
				if (locationRes.$ === 'Ok') {
					var newLocation = locationRes.a;
					var pos = A2(author$project$Maps$Geo$latLng, newLocation.latitude, newLocation.longitude);
					var updatedMap = A2(
						author$project$Maps$updateMarkers,
						function (_n4) {
							return _List_fromArray(
								[
									A2(author$project$Maps$Marker$createCustom, author$project$Main$positionMarker, pos)
								]);
						},
						A2(
							author$project$Maps$updateMap,
							author$project$Maps$Map$viewBounds(
								A2(author$project$Maps$Geo$centeredBounds, 10, pos)),
							model.map));
					return A3(author$project$Main$isDifferentFrom, 1.0e-2, model.currentLocation, newLocation) ? _Utils_Tuple2(
						_Utils_update(
							model,
							{currentLocation: newLocation, map: updatedMap}),
			...
			case 'ClickOnMap':
				var event = msgArg.a;
				var y = event.screenPos.b - (2 * model.topPos);
				var x = event.screenPos.a;
				var markerPos = A2(
					author$project$Maps$Convert$screenOffsetToLatLng,
					author$project$Maps$Convert$getMap(model.map),
					{x: x, y: y});
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							map: A2(
								...
								function (_n5) {
									return _List_fromArray(
										[
											A2(author$project$Maps$Marker$createCustom, author$project$Main$targetMarker, markerPos)
										]);
								},
								model.map),
							offsetPos: _Utils_Tuple2(x, y)
						}),
					elm$core$Platform$Cmd$none);
			default:
				var ev = msgArg.a;
...
var author$project$Main$ClickOnMap = function (a) {
	return {$: 'ClickOnMap', a: a};
};
var author$project$Main$TopClick = function (a) {
	return {$: 'TopClick', a: a};
};
...
var author$project$Main$onClick = A2(
	mpizenberg$elm_pointer_events$Html$Events$Extra$Mouse$onWithOptions,
	'click',
	{preventDefault: false, stopPropagation: false});
var elm$core$Debug$toString = _Debug_toString;
var author$project$Main$viewTup = function (_n0) {
	var a = _n0.a;
	var b = _n0.b;
	return elm$core$Debug$toString(a) + (':' + (elm$core$Debug$toString(b) + '\n'));
};
var author$project$Maps$Internal$Map$Moved = function (a) {
	return {$: 'Moved', a: a};
};
var author$project$Maps$Internal$Map$Scaled = function (a) {
	return {$: 'Scaled', a: a};
};
var author$project$Maps$Internal$Screen$offsetFromTileOffset = F2(
	function (_n0, tile) {
		var tileSize = _n0.tileSize;
		var zoom = _n0.zoom;
		var width = _n0.width;
		...
		var centerTile = A2(
			...
			elm$core$Basics$ceiling(zoom),
			center);
		return A2(author$project$Maps$Internal$Screen$Offset, ((tile.x - centerTile.x) * tileSize) + (width / 2), ((tile.y - centerTile.y) * tileSize) + (height / 2));
	});
var author$project$Maps$Internal$Screen$offsetFromLatLng = F2(
	function (map, latLng) {
		var tileSize = map.tileSize;
		var zoom = map.zoom;
		return A2(
			author$project$Maps$Internal$Screen$offsetFromTileOffset,
			map,
			A2(
				author$project$Maps$Internal$Tile$fromLatLng,
				elm$core$Basics$ceiling(zoom),
...
var author$project$Maps$Internal$Map$diff = F2(
	function (newMap, oldMap) {
		...
		return _List_fromArray(
			[
				author$project$Maps$Internal$Map$Moved(
				A2(
					sub,
					A2(author$project$Maps$Internal$Screen$offsetFromLatLng, newMap, oldMap.center),
					A2(author$project$Maps$Internal$Screen$offsetFromLatLng, newMap, newMap.center))),
				author$project$Maps$Internal$Map$Scaled(
				function (zoomArg) {
					return A2(elm$core$Basics$pow, 2, zoomArg);
				}(
					elm$core$Basics$ceiling(newMap.zoom) - elm$core$Basics$ceiling(oldMap.zoom)))
			]);
	});
var author$project$Maps$Internal$Maps$ExternalMsg = function (a) {
	return {$: 'ExternalMsg', a: a};
};
var author$project$Maps$Internal$Drag$alwaysPreventDefault = function (msg) {
...
var author$project$Maps$Internal$Screen$decodeOffset = function () {
	var xy = A3(
		elm$json$Json$Decode$map2,
		author$project$Maps$Internal$Screen$Offset,
		A2(elm$json$Json$Decode$field, 'clientX', elm$json$Json$Decode$float),
		A2(elm$json$Json$Decode$field, 'clientY', elm$json$Json$Decode$float));
	return elm$json$Json$Decode$oneOf(
		_List_fromArray(
...
var author$project$Maps$Internal$Drag$events = F2(
	function (_n0, dragValue) {
		var dragStart = _n0.dragStart;
		var dragTo = _n0.dragTo;
		var dragStop = _n0.dragStop;
		return _List_fromArray(
			[
				_Utils_eq(dragValue, elm$core$Maybe$Nothing) ? A2(
				elm$html$Html$Events$preventDefaultOn,
				'mousedown',
				A2(
					elm$json$Json$Decode$map,
					author$project$Maps$Internal$Drag$alwaysPreventDefault,
					A2(elm$json$Json$Decode$map, dragStart, author$project$Maps$Internal$Screen$decodeOffset))) : A2(
				elm$html$Html$Events$on,
				'mousemove',
				A2(elm$json$Json$Decode$map, dragTo, author$project$Maps$Internal$Screen$decodeOffset)),
				elm$html$Html$Events$onMouseUp(dragStop),
				_Utils_eq(dragValue, elm$core$Maybe$Nothing) ? A2(
				elm$html$Html$Events$preventDefaultOn,
				'touchstart',
				A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$Maps$Internal$Drag$alwaysPreventDefault,
					elm$json$Json$Decode$succeed(dragStop)))
			]);
	});
var author$project$Maps$Internal$Maps$DragStart = function (a) {
	return {$: 'DragStart', a: a};
};
var author$project$Maps$Internal$Maps$DragStop = {$: 'DragStop'};
var author$project$Maps$Internal$Maps$DragTo = function (a) {
	return {$: 'DragTo', a: a};
};
var author$project$Maps$Internal$Maps$dragEvents = function (drag) {
	return A2(
		author$project$Maps$Internal$Drag$events,
		{dragStart: author$project$Maps$Internal$Maps$DragStart, dragStop: author$project$Maps$Internal$Maps$DragStop, dragTo: author$project$Maps$Internal$Maps$DragTo},
		drag);
};
...
var author$project$Maps$Internal$Tile$formatInt = F2(
	function (replace, number) {
		return A2(
			...
			A2(
				...
				elm$regex$Regex$fromString(replace)),
			function (_n0) {
				return elm$core$String$fromInt(number);
			});
	});
var author$project$Maps$Internal$Tile$makeUrl = F4(
	function (tileServer, zoom, x, y) {
		return A3(
			author$project$Maps$Internal$Tile$formatInt,
			'{y}',
			y,
			A3(
				author$project$Maps$Internal$Tile$formatInt,
				'{x}',
				x,
				A3(author$project$Maps$Internal$Tile$formatInt, '{z}', zoom, tileServer)));
	});
var author$project$Maps$Internal$Utils$cartesianMap = F3(
	function (_function, rows, columns) {
		return A2(
			elm$core$List$map,
			author$project$Maps$Internal$Utils$flip(elm$core$List$map)(rows),
			A2(
				author$project$Maps$Internal$Utils$flip(elm$core$List$map),
				columns,
				author$project$Maps$Internal$Utils$flip(_function)));
	});
var author$project$Maps$Internal$Map$tiles = function (map) {
	...
	var wrapTile = A2(
		author$project$Maps$Internal$Utils$wrap,
		0,
		A2(
			elm$core$Basics$pow,
			2,
			elm$core$Basics$ceiling(map.zoom)));
	var tile = A2(
		author$project$Maps$Internal$Tile$fromLatLng,
		elm$core$Basics$ceiling(map.zoom),
		map.center);
	var tileXY = F2(
		function (x, y) {
			return _Utils_Tuple2(
				A4(
					author$project$Maps$Internal$Tile$makeUrl,
					map.tileServer,
					elm$core$Basics$ceiling(map.zoom),
					wrapTile(
				...
				A2(
					author$project$Maps$Internal$Tile$Offset,
	...
	return elm$core$List$concat(
		A3(author$project$Maps$Internal$Utils$cartesianMap, tileXY, xTiles, yTiles));
};
var elm$core$String$fromFloat = _String_fromNumber;
var author$project$Maps$Internal$Map$transformationStyle = F3(
	function (mapWidth, mapHeight, transforms) {
		var transformations = function (transform) {
			if (transform.$ === 'Moved') {
				var offset = transform.a;
				return 'translate(' + (elm$core$String$fromFloat(offset.x) + ('px, ' + (elm$core$String$fromFloat(offset.y) + 'px)')));
			} else {
				var scale = transform.a;
				return 'scale(' + (elm$core$String$fromFloat(scale) + ')');
			}
		};
		var style = A2(
			elm$core$String$join,
			' ',
			A2(elm$core$List$map, transformations, transforms));
		return _List_fromArray(
			[
				_Utils_Tuple2(
				'transform-origin',
				elm$core$String$fromFloat(mapWidth / 2) + ('px ' + (elm$core$String$fromFloat(mapHeight / 2) + 'px'))),
				_Utils_Tuple2('transform', style)
			]);
	});
var author$project$Maps$Internal$Tile$fromFloat = elm$core$String$fromFloat;
...
var author$project$Maps$Internal$Tile$view = F2(
	function (tileSize, _n0) {
		var url = _n0.a;
		var offset = _n0.b;
		return A2(
			elm$html$Html$img,
			_List_fromArray(
				[
					...
					'left',
					author$project$Maps$Internal$Tile$fromFloat(offset.x) + 'px'),
					A2(
					elm$html$Html$Attributes$style,
					'top',
					author$project$Maps$Internal$Tile$fromFloat(offset.y) + 'px'),
					A2(
					elm$html$Html$Attributes$style,
					'width',
					author$project$Maps$Internal$Tile$fromFloat(tileSize) + 'px'),
					A2(
					elm$html$Html$Attributes$style,
					'height',
					author$project$Maps$Internal$Tile$fromFloat(tileSize) + 'px'),
...
var author$project$Maps$Internal$Maps$tilesView = F2(
	function (transforms, map) {
		var content = A2(
			elm$core$List$map,
			function (tile) {
				var url = tile.a;
				...
				return _Utils_Tuple2(
					url,
					A2(author$project$Maps$Internal$Tile$view, map.tileSize, tile));
			},
			author$project$Maps$Internal$Map$tiles(map));
		var attrs = A2(
			elm$core$List$map,
			function (_n0) {
				var prop = _n0.a;
			...
			A3(author$project$Maps$Internal$Map$transformationStyle, map.width, map.height, transforms));
		return A3(elm$html$Html$Keyed$node, 'div', attrs, content);
	});
var author$project$Maps$Internal$Maps$PinchStart = function (a) {
	return {$: 'PinchStart', a: a};
};
var author$project$Maps$Internal$Maps$PinchStop = {$: 'PinchStop'};
var author$project$Maps$Internal$Maps$PinchTo = function (a) {
	return {$: 'PinchTo', a: a};
};
var author$project$Maps$Internal$Maps$Zoom = F2(
	function (a, b) {
		return {$: 'Zoom', a: a, b: b};
	});
var author$project$Maps$Internal$Screen$TwoFingers = F2(
	function (length, center) {
		return {center: center, length: length};
	});
...
var author$project$Maps$Internal$Screen$decodeTwoFingers = function () {
	var xy = A3(
		elm$json$Json$Decode$map2,
		author$project$Maps$Internal$Screen$Offset,
		A2(elm$json$Json$Decode$field, 'clientX', elm$json$Json$Decode$float),
	...
	var twoFingers = F2(
		function (first, second) {
			return A2(
				author$project$Maps$Internal$Screen$TwoFingers,
				A2(
					elm$core$Basics$pow,
					A2(elm$core$Basics$pow, first.x - second.x, 2) + A2(elm$core$Basics$pow, first.y - second.y, 2),
					0.5),
				A2(author$project$Maps$Internal$Screen$Offset, (first.x + second.x) / 2, (first.y + second.y) / 2));
		});
...
var author$project$Maps$Internal$Screen$scrollToZoom = function (scroll) {
	return -(scroll * 2.0e-2);
};
var author$project$Maps$Internal$Screen$decodeZoom = A2(
	elm$json$Json$Decode$map,
	author$project$Maps$Internal$Screen$scrollToZoom,
	A2(elm$json$Json$Decode$field, 'deltaY', elm$json$Json$Decode$float));
var author$project$Maps$Internal$Utils$noDefaultButPropagate = function (msg) {
	return {message: msg, preventDefault: true, stopPropagation: false};
};
var author$project$Maps$Internal$Zoom$events = F2(
	function (_n0, mapZoom) {
		var zoom = _n0.zoom;
		var pinchStart = _n0.pinchStart;
		var pinchTo = _n0.pinchTo;
		var pinchStop = _n0.pinchStop;
		return _List_fromArray(
			[
				A2(
				elm$html$Html$Events$custom,
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$Maps$Internal$Utils$noDefaultButPropagate,
					A2(
						elm$json$Json$Decode$map,
						function (offset) {
							return A2(zoom, offset, 1);
						},
						author$project$Maps$Internal$Screen$decodeOffset))),
				A2(
				elm$html$Html$Events$custom,
				'wheel',
				A2(
					elm$json$Json$Decode$map,
					author$project$Maps$Internal$Utils$noDefaultButPropagate,
					A3(elm$json$Json$Decode$map2, zoom, author$project$Maps$Internal$Screen$decodeOffset, author$project$Maps$Internal$Screen$decodeZoom))),
				A2(
				elm$html$Html$Events$custom,
				'touchstart',
				A2(
					...
					A2(
						elm$json$Json$Decode$map,
						elm$core$Maybe$withDefault(pinchStop),
						A2(
							elm$json$Json$Decode$map,
							elm$core$Maybe$map(pinchStart),
							author$project$Maps$Internal$Screen$decodeTwoFingers)))),
				A2(
				elm$html$Html$Events$custom,
				'touchmove',
				A2(
				...
				A2(
					elm$json$Json$Decode$map,
					author$project$Maps$Internal$Utils$noDefaultButPropagate,
					elm$json$Json$Decode$succeed(pinchStop)))
			]);
	});
var author$project$Maps$Internal$Maps$zoomEvents = function (zoom) {
	return A2(
		author$project$Maps$Internal$Zoom$events,
		{pinchStart: author$project$Maps$Internal$Maps$PinchStart, pinchStop: author$project$Maps$Internal$Maps$PinchStop, pinchTo: author$project$Maps$Internal$Maps$PinchTo, zoom: author$project$Maps$Internal$Maps$Zoom},
		zoom);
};
var author$project$Maps$Internal$Marker$fromFloat = elm$core$String$fromFloat;
var author$project$Maps$Internal$Marker$fromInt = elm$core$String$fromInt;
var author$project$Maps$Internal$Marker$markerSvg = '<svg xmlns=\'http://www.w3.org/2000/svg\' x=\'0px\' y=\'0px\' width=\'12\' height=\'24\' fill=\'#cc6666\' stroke=\'#000000\' version=\'1.1\' viewBox=\'0 0 12 24\'><path d=\'M 2,12 A 5.5,5.5 0 1,1 10,12 C 8,14 6,22 6,24 C 6,22 4,14 2,12 z  M 4,8.5 A 2,2 0 1,0 8,8.5 A 2,2 0 0,0 4,8.5 z\' fill-rule=\'evenodd\'/></svg>';
var author$project$Maps$Internal$Marker$view = F2(
	function (map, marker) {
		if (marker.$ === 'DefaultMarker') {
			var latLng = marker.a;
			var width = 18;
			var offset = A2(author$project$Maps$Internal$Screen$offsetFromLatLng, map, latLng);
			var height = 36;
			return A2(
				elm$html$Html$span,
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$style,
						'left',
						author$project$Maps$Internal$Marker$fromFloat(offset.x - (width / 2)) + 'px'),
						A2(
						elm$html$Html$Attributes$style,
						'top',
						author$project$Maps$Internal$Marker$fromFloat(offset.y - height) + 'px'),
						A2(elm$html$Html$Attributes$style, 'display', 'inline-block'),
						A2(
						elm$html$Html$Attributes$style,
						'width',
						author$project$Maps$Internal$Marker$fromInt(width) + 'px'),
						A2(
						elm$html$Html$Attributes$style,
						'height',
						author$project$Maps$Internal$Marker$fromInt(height) + 'px'),
						A2(elm$html$Html$Attributes$style, 'background-image', 'url(\"data:image/svg+xml;utf-8,' + (author$project$Maps$Internal$Marker$markerSvg + '\")')),
						A2(elm$html$Html$Attributes$style, 'background-size', '100% auto')
					]),
				_List_Nil);
		} else {
			var html = marker.a;
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$style,
						'left',
						author$project$Maps$Internal$Marker$fromFloat(offset.x) + 'px'),
						A2(
						elm$html$Html$Attributes$style,
						'top',
						author$project$Maps$Internal$Marker$fromFloat(offset.y) + 'px'),
						A2(elm$html$Html$Attributes$style, 'pointer-events', 'initial'),
						A2(elm$html$Html$Attributes$style, 'display', 'inline-block'),
						A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
						A2(elm$html$Html$Attributes$style, '-webkit-transform', 'translateX(-50%) translateY(-50%)'),
						A2(elm$html$Html$Attributes$style, '-moz-transform', 'translateX(-50%) translateY(-50%)'),
...
var author$project$Maps$Internal$Maps$view = function (model) {
	var map = model.map;
	var cache = model.cache;
	var markers = model.markers;
	var pinch = model.pinch;
	var drag = model.drag;
	return A2(
		elm$html$Html$div,
		_Utils_ap(
			_List_fromArray(
				[
					...
					elm$html$Html$Attributes$style,
					'width',
					elm$core$String$fromFloat(map.width) + 'px'),
					A2(
					elm$html$Html$Attributes$style,
					'height',
					elm$core$String$fromFloat(map.height) + 'px'),
			...
			author$project$Maps$Internal$Maps$zoomEvents(map.zoom)),
		function () {
			var zoom = A2(
				elm$core$Maybe$map,
				A2(author$project$Maps$Internal$Zoom$fromPinch, map.width, map.height),
				pinch);
			var zoomedMap = A2(
				elm$core$Maybe$withDefault,
				map,
				A2(
					...
					function (_n0) {
						var zoomArg = _n0.a;
						var offset = _n0.b;
						return A3(author$project$Maps$Internal$Map$zoomTo, zoomArg, offset, map);
					},
					zoom));
			var transforms = A2(author$project$Maps$Internal$Map$diff, zoomedMap, map);
			return _List_fromArray(
				[
					A2(
					elm$html$Html$div,
					_List_fromArray(
						[
							...
							A2(
								elm$json$Json$Decode$map,
								author$project$Maps$Internal$Utils$noDefaultButPropagate,
								elm$json$Json$Decode$fail('No interaction')))
						]),
					A2(
						elm$core$List$map,
						function (cachedMap) {
							return A2(
								author$project$Maps$Internal$Maps$tilesView,
								A2(author$project$Maps$Internal$Map$diff, zoomedMap, cachedMap),
								cachedMap);
						},
						elm$core$List$reverse(cache))),
					A2(
					elm$html$Html$div,
					_Utils_ap(
						_List_fromArray(
						...
						author$project$Maps$Internal$Maps$dragEvents(drag)),
					_List_fromArray(
						[
							A2(author$project$Maps$Internal$Maps$tilesView, transforms, map)
						])),
					A2(
					elm$html$Html$div,
					_List_fromArray(
					...
					A2(
						elm$core$List$map,
						elm$html$Html$map(author$project$Maps$Internal$Maps$ExternalMsg),
						A2(
							elm$core$List$map,
							author$project$Maps$Internal$Marker$view(zoomedMap),
							markers)))
				]);
		}());
};
var author$project$Maps$view = function (_n0) {
	var model = _n0.a;
	return author$project$Maps$Internal$Maps$view(model);
};
				...
				A2(
					...
					_List_fromArray(
						[
							...
							author$project$Main$onClick(author$project$Main$TopClick))
						]),
					_List_fromArray(
						[
							mdgriffith$stylish_elephants$Element$text('New Html Program'),
							mdgriffith$stylish_elephants$Element$text(
							author$project$Main$viewTup(model.clientPos)),
							mdgriffith$stylish_elephants$Element$text(
							author$project$Main$viewTup(model.offsetPos)),
							A2(
							mdgriffith$stylish_elephants$Element$el,
							_List_fromArray(
								[
									mdgriffith$stylish_elephants$Element$htmlAttribute(
									author$project$Main$onClick(author$project$Main$ClickOnMap)),
									mdgriffith$stylish_elephants$Element$htmlAttribute(
									elm$html$Html$Attributes$id('mapWindow'))
								]),
							mdgriffith$stylish_elephants$Element$html(
								A2(
									elm$html$Html$map,
									author$project$Main$MapsMsg,
									author$project$Maps$view(model.map))))
						])))
			]),
		title: 'Wakeme'
	};
...
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Main.Msg","aliases":{"Geolocation.Altitude":{"args":[],"type":"{ value : Basics.Float, accuracy : Basics.Float }"},"Geolocation.Location":{"args":[],"type":"{ latitude : Basics.Float, longitude : Basics.Float, accuracy : Basics.Float, altitude : Maybe.Maybe Geolocation.Altitude, movement : Maybe.Maybe Geolocation.Movement, timestamp : Time.Posix }"},"Main.Data":{"args":[],"type":"Maybe.Maybe Maps.Map.Map"},"Maps.Msg":{"args":["msg"],"type":"Maps.Internal.Maps.Msg msg"},"Maps.Map.Map":{"args":[],"type":"Maps.Internal.OpaqueTypes.Map"},"Browser.Dom.Element":{"args":[],"type":"{ scene : { width : Basics.Float, height : Basics.Float }, viewport : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float }, element : { x : Basics.Float, y : Basics.Float, width : Basics.Float, height : Basics.Float } }"},"Html.Events.Extra.Mouse.Event":{"args":[],"type":"{ keys : Html.Events.Extra.Mouse.Keys, button : Html.Events.Extra.Mouse.Button, clientPos : ( Basics.Float, Basics.Float ), offsetPos : ( Basics.Float, Basics.Float ), pagePos : ( Basics.Float, Basics.Float ), screenPos : ( Basics.Float, Basics.Float ) }"},"Html.Events.Extra.Mouse.Keys":{"args":[],"type":"{ alt : Basics.Bool, ctrl : Basics.Bool, shift : Basics.Bool }"},"Geolocation.MovingData":{"args":[],"type":"{ speed : Basics.Float, degreesFromNorth : Basics.Float }"},"Maps.Internal.LatLng.LatLng":{"args":[],"type":"{ lat : Basics.Float, lng : Basics.Float }"},"Maps.Internal.Map.Map":{"args":[],"type":"{ tileServer : String.String, zoom : Maps.Internal.Screen.ZoomLevel, center : Maps.Internal.LatLng.LatLng, width : Basics.Float, height : Basics.Float, tileSize : Basics.Float }"},"Maps.Internal.Screen.Offset":{"args":[],"type":"{ x : Basics.Float, y : Basics.Float }"},"Maps.Internal.Screen.TwoFingers":{"args":[],"type":"{ length : Basics.Float, center : Maps.Internal.Screen.Offset }"},"Maps.Internal.Screen.ZoomLevel":{"args":[],"type":"Basics.Float"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"}},"unions":{"Main.Msg":{"args":[],"tags":{"NoOp":[],"MapsMsg":["Maps.Msg Main.Data"],"LocationUpdated":["Result.Result Json.Decode.Error Geolocation.Location"],"ClickOnMap":["Html.Events.Extra.Mouse.Event"],"TopClick":["Html.Events.Extra.Mouse.Event"],"UpdateMapWindowPosition":["Result.Result Browser.Dom.Error Browser.Dom.Element"]}},"Geolocation.Movement":{"args":[],"tags":{"Static":[],"Moving":["Geolocation.MovingData"]}},"Maps.Internal.Maps.Msg":{"args":["msg"],"tags":{"DragStart":["Maps.Internal.Screen.Offset"],"DragTo":["Maps.Internal.Screen.Offset"],"DragStop":[],"PinchStart":["Maps.Internal.Screen.TwoFingers"],"PinchTo":["Maps.Internal.Screen.TwoFingers"],"PinchStop":[],"Zoom":["Maps.Internal.Screen.Offset","Maps.Internal.Screen.ZoomLevel"],"ExternalMsg":["msg"]}},"Maps.Internal.OpaqueTypes.Map":{"args":[],"tags":{"Map":["Maps.Internal.Map.Map"]}},"Browser.Dom.Error":{"args":[],"tags":{"NotFound":["String.String"]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"Json.Decode.Error":{"args":[],"tags":{"Field":["String.String","Json.Decode.Error"],"Index":["Basics.Int","Json.Decode.Error"],"OneOf":["List.List Json.Decode.Error"],"Failure":["String.String","Json.Decode.Value"]}},"Time.Posix":{"args":[],"tags":{"Posix":["Basics.Int"]}},"Html.Events.Extra.Mouse.Button":{"args":[],"tags":{"ErrorButton":[],"MainButton":[],"MiddleButton":[],"SecondButton":[],"BackButton":[],"ForwardButton":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"List.List":{"args":["a"],"tags":{}},"String.String":{"args":[],"tags":{"String":[]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}}}}})}});}(this));